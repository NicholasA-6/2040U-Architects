...
from WatchCatalogue.backend import Role, Watch, User, Admin, Catalogue, Review
...
def load_watches_from_csv(filepath, catalogue):
...
load_watches_from_csv(csv_path, catalogue)
